...
class JNIFactorialTest {
    @Test
    fun `bytedeco factorial example runs`() {
        ...
        val fac_args = arrayOf(LLVM.LLVMInt32Type())
        val fac = LLVM.LLVMAddFunction(mod, "fac", LLVM.LLVMFunctionType(LLVM.LLVMInt32Type(), fac_args[0], 1, 0))
